        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center max-w-7xl mx-auto">
          ...
          <div className="space-y-6 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 bg-indigo-50 text-indigo-600 px-4 py-1.5 rounded-full text-sm font-medium border border-indigo-100">
              <span>✨</span> Smarter Budgeting, Zero Stress
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
              ...
              <button className="bg-white text-gray-700 font-medium py-3.5 px-8 rounded-xl border border-gray-300 hover:bg-gray-50 flex items-center justify-center gap-2">
